...
us_supply_geocoded %>% 
  ...
  count()
```
Fortunately, again, out of our 1043 observations, only 64 return as with an invalid address. We add this to the same task as imputing multiple location data. 
  ...
  name <- df %>% 
    mutate(layerId = paste(broad_loc, row_number(), sep = '.'),
                      popup = paste("Company Name:",
                                    ...
                                    df$ownership, "<br>",
                                    "Affirmatively Participating in COVID-19 Response?", 
                                    df$covid_resp, "<br>",
                                    "Meets FDA/Technical Specs?", 
                                    df$useful, "<br>",
                                    "Company Type:", 
                                    df$broad_loc, "<br>",
                                    "Address:", 
