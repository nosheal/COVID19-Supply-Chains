...
thomas_endprods <- bind_rows(thomas_files[[1]], thomas_files[[2]]) %>% 
  ...
  bind_rows(thomas_files[[9]]) %>% 
  bind_rows(thomas_files[[10]]) %>% 
  bind_rows(thomas_files[[11]]) %>% 
  bind_rows(thomas_files[[12]]) %>% 
  bind_rows(thomas_files[[13]]) %>% 
  bind_rows(thomas_files[[14]]) %>% 
  bind_rows(thomas_files[[15]]) %>% 
  bind_rows(thomas_files[[16]]) %>% 
  bind_rows(thomas_files[[17]]) %>% 
  bind_rows(thomas_files[[18]]) %>% 
  bind_rows(thomas_files[[19]]) %>% 
  bind_rows(thomas_files[[20]]) %>% 
  bind_rows(thomas_files[[21]]) %>% 
  bind_rows(thomas_files[[22]]) %>% 
  bind_rows(thomas_files[[23]]) %>% 
  bind_rows(thomas_files[[24]]) %>% 
  bind_rows(thomas_files[[25]]) %>% 
  bind_rows(thomas_files[[26]]) %>% 
  bind_rows(thomas_files[[27]]) %>% 
  bind_rows(thomas_files[[28]])
