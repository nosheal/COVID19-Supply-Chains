...
prod_struc1 <- function(data) {
  ...
  mutate(resp = case_when(
    str_detect(desc, fixed("respirator", ignore_case = TRUE)) | 
      ...
      str_detect(desc, fixed("KN-95", ignore_case = TRUE)) |
    ...
    face_mask = case_when(
      str_detect(desc, fixed("medical", ignore_case = TRUE)) |
        ...
        str_detect(desc, fixed("4-ply", ignore_case = FALSE)) |
        str_detect(desc, fixed("5-ply", ignore_case = FALSE)) |
