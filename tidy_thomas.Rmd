...
sup_type <- thomas_struc %>%
  ...
  geom_label(show.legend = FALSE) +
  theme_bw() + 
  labs(title = "Number of Suppliers by Specific End Product Type", subtitle = "by Supplier Type, Thomasnet 5/29/20", y = "", x = "", fill = "Specific Product") + 
  theme(axis.ticks.x = element_blank(), axis.text.x = element_blank())
```
...
int_prod %>% 
  ...
  labs(title = "Number of Suppliers by Intermediary Product Type", subtitle = "Thomasnet 5/29/20", y = "", x = "", fill = "Specific Product") + 
  theme(axis.ticks.x = element_blank(), axis.text.x = element_blank())
```
...
int_prod %>%
  ...
  coord_flip() +
  theme_bw() + 
  labs(title = "Percent of US Suppliers of Intermediary Products, \nby Supplier Type", subtitle = "Technology = Masks, Thomasnet 5/29/2020", fill = "Supplier Type", x = "", y = "Proportion")
```
...
```{r}
product_words <- as.data.frame(c("covid", "coronavirus", "N95", "KN95", "mask", "masks", "cloth", "surgical", "medical", "ppe", "disposable", "19", "dust", "industrial", "gloves", "gowns", "respirators", "face", "include", "product", "equipment", "supplies", "including", "saftey"))
