...
sup1 <- thomas_struc %>% 
  ...
  labs(title = "Number of Suppliers by Product and Thomasnet Supplier Type", subtitle = "Thomasnet 05/30/20 - 09/21/20", y = "Unique Thomasnet Suppliers", x = "", fill = "Supplier Type") + 
  theme_bw()
...
fig_0 <- fig_base + 
  ...
  labs(title = "Potential Domestic Manufacturing Entities by Product Type", subtitle = "Source: Thomasnet, 09/08/20.", x = "", y = "Unique Manufacturing Entities")
```
...
fig_1 <- fig_base +
  ...
  labs(title = "Number of Potential Domestic Manufacturing Entities by Product Type", subtitle = "Source: Thomasnet, 09/08/20. Manufacturers Self-Identifying as: \nProducing Standard Products for FDA Approved, Hospital Grade Masks/Respirators", x = "", y = "Unique Manufacturing Entities")
...
time_conf <- base2 + 
  ...
  labs(title = "Confirmed Domestic Manufacturers (Blue), Unknown Manufacturing Entities (Grey), and \nConfirmed Non-Domestic or Non-manufacturing Entities (Black)", subtitle = "Thomasnet 05/30/20 - 09/21/20 \nManufacturers Self-Identifying as: \nProducing Standard Products for FDA Approved, Hospital Grade Masks", y = "Unique Manufacturing Entities", x = "") 
```
...
conf_dom %>% 
  ...
  ggplot(aes(reorder(company, pos), date)) + 
...
extra_fig <- aff_dom %>% 
  ...
  theme_bw() + 
  labs(title = "Confirmed Domestic Manufacturing Entities of Hospital Grade Masks/Respirators or the Intermediary Products Thereof, Over Time", subtitle = "Thomasnet, 05/29/20 - 09/21/20", x = "", y = "Unique Domestic Manufacturing Entity")
```
