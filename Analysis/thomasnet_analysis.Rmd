...
fig1lab <- fig1 + geom_label(show.legend = FALSE) 
...
```{r}
fig2 <- fig1 +
  geom_col(data = fda_graph, aes(specific_product, n_fda, fill = specific_product), color = "Black", position = "stack") +
  geom_label(data = fda_graph, aes(label = n_fda), show.legend = FALSE) +
  labs(fill = "Affirmatively Meets FDA Specs")
...
sup1 <- thomas_struc %>% 
  ...
  labs(title = "Number of Suppliers by Product and Supplier Type", subtitle = "Affirmatively Meeting FDA Specs, Thomasnet 5/29/20", y = "", x = "", fill = "Supplier Type") 
```
...
sup2 <- thomas_struc %>% 
  ...
  labs(title = "Number of Suppliers by Product and Supplier Type", subtitle = "Affirmatively or Possibly Meeting FDA Specs, Thomasnet 5/29/20. \n% Change Relative to Affirmatively Alone", y = "", x = "", fill = "Supplier Type") 
```
...
fig3 <- thomas_time %>% 
  ...
  labs(title = "Thomasnet Suppliers Over Time", subtitle = "By Supplier Type, All Product Specs", x = "", y = "Suppliers", fill = "") + 
  theme_bw()
```
