...
pivot_manf <- pivot_base +    
  ...
  scale_fill_manual(values = mypal2) +
  labs(title = "Thomasnet Listed Manufacturers With Pivot or Scale Relevant \nWords in Thomasnet Descriptions", subtitle = "05/30/20 - 08/03/20 \nWords: 'pivot', 'shift', 'new', 'scaled', 'scale up', 'ramp', 'increase', 'now'", y = "Unique Thomasnet Suppliers", fill = "Specific Product", x = "")
```
