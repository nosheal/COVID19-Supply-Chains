...
```{r}
my_pal <- c(brewer.pal(3, "Set3")[2], brewer.pal(3, "Set3")[1], "grey")
```
...
sup2 <- thomas_struc %>% 
  ...
  labs(title = "Number of Suppliers by Product and Supplier Type", subtitle = "Affirmatively or Possibly Meeting FDA Specs, Thomasnet 5/29/20", y = "", x = "", fill = "Supplier Type") 
```
