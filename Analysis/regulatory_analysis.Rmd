...
country_niosh <- country_count %>% 
  ...
  ggplot() + 
  geom_col(aes(x = ddate, y = n, group = domestic, fill = domestic), position = position_dodge(width = 30, preserve = "total"), show.legend = FALSE) + 
...
size_niosh <- country_niosh + 
  ...
  geom_col(data = niosh_graph1, aes(x = ddate, y = n, group = firm_size, fill = reorder(firm_size, size_pos)), position = "stack", color = "Dark Grey", width = 30, show.legend = FALSE) + 
...
size_510k <- country_510k + 
  ...
  geom_col(data = graph_510k1, aes(x = ddate, y = n, group = firm_size, fill = reorder(firm_size, size_pos)), position = "stack", color = "Dark Grey", width = 30, show.legend = FALSE) + 
  scale_fill_manual(values = size_col, na.value = "White") + 
  scale_x_date(date_labels = "%b, %y", breaks = "month", limits = as.Date(c("2019-12-30","2021-06-01")))
```
...
size_eua <- country_eua + 
  ...
  geom_col(data = eua_graph1, aes(x = ddate, y = n, group = firm_size, fill = reorder(firm_size, size_pos)), position = "stack", color = "Dark Grey", width = 30, show.legend = FALSE) + 
  scale_fill_manual(values = size_col, na.value = "White") + 
