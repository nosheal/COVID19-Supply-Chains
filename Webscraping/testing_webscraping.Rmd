...
box_dir <- "C:/Users/Nikhil Kalathil/Box/COVID 19 Master Folder/Data/Tests/Thomasnet Pulls/06_07_2021"
...
```{r}
saveRDS(covid_tk, box_here("/covid_tk_06072021.RDS"))
```
...
```{r}
saveRDS(sero_tk, box_here("/sero_tk_06072021.RDS"))
```


```{r}
test_end <- bind_rows(covid_tk, sero_tk) %>% 
  saveRDS(box_here("/test_end_06072021.RDS"))
```
...
```{r}
saveRDS(oro_swabs, box_here("/oro_swabs_06072021.RDS"))
```
...
```{r}
saveRDS(naso_swabs, box_here("/naso_swabs_06072021.RDS"))
```
...
```{r}
saveRDS(vtm, box_here("/vtm_06072021.RDS"))
```
...
```{r}
saveRDS(pcm, box_here("/pcm_06072021.RDS"))
```
...
```{r}
saveRDS(pcm_medical, box_here("/pcm_medical_06072021.RDS"))
```
...
```{r}
saveRDS(rna_ext, box_here("/rna_ext_06072021.RDS"))
```
...
```{r}
saveRDS(nucleotides, box_here("/nucleotides_06072021.RDS"))
```
...
```{r}
saveRDS(reagents_full, box_here("/reagents_full_06072021.RDS"))
```
...
```{r}
saveRDS(reagents_all, box_here("/reagents_all_06072021.RDS"))
```
...
test_int <- bind_rows(oro_swabs, naso_swabs) %>% 
  ...
  saveRDS(box_here("/test_int_06072021.RDS"))
```
...
```{r}
saveRDS(other_products, box_here("/test_other_06072021.RDS"))
```
