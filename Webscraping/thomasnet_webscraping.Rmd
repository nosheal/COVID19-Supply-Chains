...
```{r}
dir <- "C:/Users/surface/Box/COVID 19 Master Folder/Data/Masks/Weekly Thomasnet Pulls/12_07"
```
...
box_dir <- "C:/Users/Nikhil Kalathil/Box/COVID 19 Master Folder/Data/Masks/Weekly Thomasnet Pulls/12_07"
...
```{r}
saveRDS(thomas_fm, box_here("/thomas_fm_12072020.RDS"))
```
...
```{r}
saveRDS(thomas_resp, box_here("/thomas_resp_12072020.RDS"))
```
...
```{r}
save_loc <- paste(dir, box_here("/nonwoven_12072020.RDS"), sep = "")
```

```{r}
saveRDS(nonwoven_final, box_here("/nonwoven_12072020.RDS"))
```
...
```{r}
save_loc <- paste(dir, box_here("/nolatex_12072020.RDS"), sep = "")
```

```{r}
saveRDS(nolatex_final, box_here("/nolatex_12072020.RDS"))
```
