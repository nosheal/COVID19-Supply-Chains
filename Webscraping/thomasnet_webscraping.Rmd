...
```{r}
dir <- "C:/Users/surface/Box/COVID 19 Master Folder/Data/Masks/Weekly Thomasnet Pulls/07_20"
```
...
```{r}
save_loc <- paste(dir, "/thomas_fm_07202020.RDS", sep = "")
```
...
```{r}
save_loc <- paste(dir, "/thomas_resp_07202020.RDS", sep = "")
```
...
```{r}
save_loc <- paste(dir, "/nonwoven_07202020.RDS", sep = "")
```
...
```{r}
save_loc <- paste(dir, "/nolatex_07202020.RDS", sep = "")
```
