...
```{r}
saveRDS(final_data, "Data/thomas_fm_06052020.RDS")
```
...
```{r}
saveRDS(final_data, "Data/thomas_resp_0605202.RDS")
```
...
```{r}
saveRDS(nonwoven_final, "Data/nonwoven_0605202.RDS")
```
...
```{r}
saveRDS(nolatex_final, "Data/nolatex_06052020.RDS")
```
