...
```{r}
saveRDS(final_data, here("Data/thomas_fm_06162020.RDS"))
```
...
```{r}
saveRDS(final_data, here("Data/thomas_resp_0616202.RDS"))
```
...
```{r}
saveRDS(nonwoven_final, here("Data/nonwoven_06162020.RDS"))
```
...
```{r}
saveRDS(nolatex_final, here("Data/nolatex_06162020.RDS"))
```
