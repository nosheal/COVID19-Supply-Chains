...
```{r}
save_loc <- paste(dir, "/07_06/thomas_fm_07062020.RDS", sep = "")
```
...
```{r}
save_loc <- paste(dir, "/07_06/thomas_resp_07062020.RDS", sep = "")
```
...
```{r}
save_loc <- paste(dir, "/07_06/nonwoven_07062020.RDS", sep = "")
```
...
```{r}
save_loc <- paste(dir, "/07_06/nolatex_07062020.RDS", sep = "")
```
