...
```{r}
dir <- "C:/Users/surface/Box/COVID 19 Master Folder/Data/Masks/Weekly Thomasnet Pulls/12_06_2021"
```
...
box_dir <- "C:/Users/Nikhil Kalathil/Box/COVID 19 Master Folder/Data/Masks/Weekly Thomasnet Pulls/12_06_2021"
...
```{r}
saveRDS(thomas_fm, box_here("/thomas_fm_12062021.RDS"))
```
...
```{r}
saveRDS(thomas_resp, box_here("/thomas_resp_12062021.RDS"))
```
...
```{r}
save_loc <- paste(dir, box_here("/nonwoven_12062021.RDS"), sep = "")
```

```{r}
saveRDS(nonwoven_final, box_here("/nonwoven_12062021.RDS"))
```
...
```{r}
save_loc <- paste(dir, box_here("/nolatex_12062021.RDS"), sep = "")
```

```{r}
saveRDS(nolatex_final, box_here("/nolatex_12062021.RDS"))
```
