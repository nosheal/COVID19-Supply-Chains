...
```{r}
save_loc <- paste(dir, "/06_29/thomas_fm_06292020.RDS", sep = "")
```

```{r}
saveRDS(thomas_fm, save_loc)
```
...
```{r}
save_loc <- paste(dir, "/06_29/thomas_resp_06292020.RDS", sep = "")
```


```{r}
saveRDS(thomas_resp, save_loc)
```

```{r}
saveRDS(final_data, here("Data/thomas_resp_06222020.RDS"))
```
...
```{r}
save_loc <- paste(dir, "/06_29/nonwoven_06292020.RDS", sep = "")
```

```{r}
saveRDS(nonwoven_final, save_loc)
```


```{r}
saveRDS(nonwoven_final, here("Data/nonwoven_06222020.RDS"))
```
...
```{r}
save_loc <- paste(dir, "/06_29/nolatex_06292020.RDS", sep = "")
```

```{r}
saveRDS(nolatex_final, save_loc)
```


```{r}
saveRDS(nolatex_final, here("Data/nolatex_06222020.RDS"))
```
