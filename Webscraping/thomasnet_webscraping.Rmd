...
```{r}
dir <- "C:/Users/surface/Box/COVID 19 Master Folder/Data/Masks/Weekly Thomasnet Pulls/11_09_2021"
```
...
box_dir <- "C:/Users/Nikhil Kalathil/Box/COVID 19 Master Folder/Data/Masks/Weekly Thomasnet Pulls/11_09_2021"
...
```{r}
saveRDS(thomas_fm, box_here("/thomas_fm_11092021.RDS"))
```
...
```{r}
saveRDS(thomas_resp, box_here("/thomas_resp_11092021.RDS"))
```
...
```{r}
save_loc <- paste(dir, box_here("/nonwoven_11092021.RDS"), sep = "")
```

```{r}
saveRDS(nonwoven_final, box_here("/nonwoven_11092021.RDS"))
```
...
```{r}
save_loc <- paste(dir, box_here("/nolatex_11092021.RDS"), sep = "")
```

```{r}
saveRDS(nolatex_final, box_here("/nolatex_11092021.RDS"))
```
